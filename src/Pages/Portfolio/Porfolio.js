                ...
                <div className="info-box p-ani-fadeInUp p-delay_1s">
                    ...
                    >
                        <div className={cx("flex", "flex-justify")}>
                            ...
                            <a href="https://thy96.github.io/flip/" className={cx("box", "p-ani-fadeInBlur", "p-delay_9s")} target="_blank" rel="noreferrer">
                                <figure>
                                    <img src={images.portfolio_10} alt="" />
                                </figure>
                                <h4>
                                    Flip<br />{" "}
                                    <i>
                            ...
                            <a href="https://thy96.github.io/thoitiet24h/" className={cx("box", "p-ani-fadeInBlur", "p-delay_15s")} target="_blank" rel="noreferrer">
                                <figure>
                                    <img src={images.portfolio_6} alt="" />
                                </figure>
                                <h4>
                                    Thời tiết 24h<br />{" "}
                                    <i>
                        ...
                        <div className={cx("flex", "flex-justify")}>
                            ...
                            <a href="https://thy96.github.io/finexo/" className={cx("box")} target="_blank" rel="noreferrer">
                                <figure>
                            ...
                            <a href="https://thy96.github.io/minimal_goods/" className={cx("box")} target="_blank" rel="noreferrer">
                                <figure>
                                    <img src={images.portfolio_8} alt="" />
                                </figure>
                                <h4>
                                    Minimal Goods<br />{" "}
                                    <i>
                            ...
                            <a href="https://thy96.github.io/studioreh/" className={cx("box")} target="_blank" rel="noreferrer">
                                <figure>
                                    <img src={images.portfolio_9} alt="" />
                                </figure>
                                <h4>
                                    Studioreh <br />{" "}
                                    <i>
                            ...
                            <a href="https://thy96.github.io/flip/" className={cx("box")} target="_blank" rel="noreferrer">
                                <figure>
                                    <img src={images.portfolio_10} alt="" />
                                </figure>
                                <h4>
